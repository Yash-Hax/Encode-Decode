...
<html lang="en">
  ...
  <div Class="heading my-4">
    <h1 class="base64">URL <span  class="en">Encode/Decode</span></h1>
  </div>
  ...
  <!-- Input OutPut encode-->
    ...
    <div class="row">
      ...
      <div class="col">
      	<h1>Output</h1>
					<br>
				<Textarea class="enoutput"><?php echo urlencode($encode);?></Textarea>
  	</div>
  </div>
  	...
  	<div class="row">
    	<div class="col">
    		<form action="index.php" method="post">
    			<h1>Decode</h1>
						<br>
					<input name="decode"  value="<?php echo htmlspecialchars($decode);?>"  class="deinput">
			  </form>
   		</div>
    	<div class="col">     
    		<h1>Output</h1>
					<br>
				<Textarea class="deoutput"><?php echo htmlspecialchars(urldecode($decode));?> </Textarea>
      </div>
    </div>
  </div>	
  <!-- Input OutPut decode closed-->
